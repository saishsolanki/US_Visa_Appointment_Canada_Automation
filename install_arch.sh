...
echo "US Visa Appointment Checker - Arch Linux Installation"
echo "====================================================="

# Check if running on Arch Linux
if ! grep -q "Arch Linux" /etc/os-release; then
    echo "This script is designed for Arch Linux. Please use the appropriate script for your distribution."
    exit 1
fi
...
# Install pip if not present (usually comes with python on Arch)
